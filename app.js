  ...
  function renderNotificationModalList() {
    ...
    filteredItems.forEach(item => {
      ...
      if (item.service === 'chatwork') {
        ...
        const roomHtml = item.room_name ? ('<div class="notify-item-room">📁 ' + escapeHtml(item.room_name) + '</div>') : '';
        ...
        const snippetHtml = item.snippet ? ('<div class="notify-item-body">' + escapeHtml(item.snippet) + '</div>') : '';
